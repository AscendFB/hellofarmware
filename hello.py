...
try:
     device.move_absolute(location=device.assemble_coordinate(100, 50, 0), speed=100, offset=device.assemble_coordinate(0, 0, 0)) # <- working
     # device.move_absolute(device.assemble_coordinate(100, 100, 0), 100, device.assemble_coordinate(0, 0, 0)) <- not working!
